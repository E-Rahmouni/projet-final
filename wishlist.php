...
<body>
    ...
    <section class="wishlist">
        ...
        <div class="box-container">
            ...
            ?>
                    <form action="" method="POST" class="box">
                        <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('delete this product?');"></a>
        ...
        <div class="wishlist-total">
            ...
            <a href="shop.php" class="option-btn">contiue shopping</a>
